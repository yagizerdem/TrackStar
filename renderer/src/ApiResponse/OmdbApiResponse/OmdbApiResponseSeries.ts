export class OmdbApiResponseSeries {
  Title: string;
  Year: string;
  Rated: string;
  Released: string;
  ...
  constructor(data: Partial<OmdbApiResponseSeries>) {
  ...
  static fromJson(json: any): OmdbApiResponseSeries {
    return new OmdbApiResponseSeries(json);
  }
}

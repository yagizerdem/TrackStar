export class OmdbApiResponseMovie {
  Title: string;
  Year: string;
  Rated: string;
  Released: string;
  ...
  constructor(data: Partial<OmdbApiResponseMovie> = {}) {
  ...
  static fromJson(json: any): OmdbApiResponseMovie {
    return new OmdbApiResponseMovie({
      Title: json.Title,
      Year: json.Year,
      Rated: json.Rated,
